...
/***/ "./components/shared/chef-profile/pricing-page/Navigation.js":
/*!*******************************************************************!*\
  !*** ./components/shared/chef-profile/pricing-page/Navigation.js ***!
  \*******************************************************************/
/*! exports provided: NavigateToProfile */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NavigateToProfile", function() { return NavigateToProfile; });
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/router */ "./node_modules/next/dist/client/router.js");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _routings_routings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../routings/routings */ "./components/routings/routings.js");


function NavigateToProfile(props) {
  // console.log('NavigateToBookongDetail', props);
  next_router__WEBPACK_IMPORTED_MODULE_0___default.a.push({
    pathname: _routings_routings__WEBPACK_IMPORTED_MODULE_1__["default"].PROFILE,
    query: props
  });
}
...
/* harmony import */ var _CalculatePrice__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./CalculatePrice */ "./components/shared/chef-profile/pricing-page/CalculatePrice.js");
...
/* harmony import */ var _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../utils/checkEmptycondition */ "./utils/checkEmptycondition.js");
/* harmony import */ var _utils_priceCalculator__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../utils/priceCalculator */ "./utils/priceCalculator.js");
/* harmony import */ var _utils_Toast__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../utils/Toast */ "./utils/Toast.js");
/* harmony import */ var react_select_creatable__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! react-select/creatable */ "./node_modules/react-select/creatable/dist/react-select.browser.esm.js");
/* harmony import */ var _payments_components_CustomerCardList__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../payments/components/CustomerCardList */ "./components/payments/components/CustomerCardList.js");
...
/* harmony import */ var _Navigation__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Navigation */ "./components/shared/chef-profile/pricing-page/Navigation.js");
...
var listStoreTag = _common_gql__WEBPACK_IMPORTED_MODULE_10__["query"].master.storeTypeGQLTAG; //gql to get store list

var LIST_STORE = graphql_tag__WEBPACK_IMPORTED_MODULE_9___default()(_templateObject(), listStoreTag); //chef

var chefDataTag = _common_gql__WEBPACK_IMPORTED_MODULE_10__["query"].chef.profileByIdGQLTAG; //for getting chef data

var GET_CHEF_DATA = graphql_tag__WEBPACK_IMPORTED_MODULE_9___default()(_templateObject2(), chefDataTag);
var editBooking = _common_gql__WEBPACK_IMPORTED_MODULE_10__["mutation"].booking.createRequestGQLTAG; //for insert dish

var EDIT_BOOKING = graphql_tag__WEBPACK_IMPORTED_MODULE_9___default()(_templateObject3(), editBooking);
var createBooking = _common_gql__WEBPACK_IMPORTED_MODULE_10__["mutation"].booking.createGQLTAG; //for insert dish

var CREATE_BOOKING = graphql_tag__WEBPACK_IMPORTED_MODULE_9___default()(_templateObject4(), createBooking); //Get commission value

var commissionValue = _common_gql__WEBPACK_IMPORTED_MODULE_10__["query"].setting.getSettingValueGQLTAG;
var COMMISSION_VALUE = graphql_tag__WEBPACK_IMPORTED_MODULE_9___default()(_templateObject5(), commissionValue);
...
var PriceCalculator = function PriceCalculator(props) {
  ...
  var _useLazyQuery = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_5__["useLazyQuery"])(LIST_STORE, {
    onError: function onError(err) {
      Object(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["toastMessage"])('renderError', err);
    }
  }),
  ...
  var createDish = _common_gql__WEBPACK_IMPORTED_MODULE_10__["mutation"].master.createDishTypeGQLTAG; //for insert dish

  var INSERT_DISH = graphql_tag__WEBPACK_IMPORTED_MODULE_9___default()(_templateObject6(), createDish);
  ...
  var _useMutation = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_5__["useMutation"])(CREATE_BOOKING, {
    onCompleted: function onCompleted(dishData) {
      ...
      closePriceModal();
      Object(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["toastMessage"])(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["success"], 'Booking created Successfully');
    },
    onError: function onError(err) {
      Object(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["toastMessage"])(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["renderError"], err.message);
    }
  }),
  ...
  var _useMutation3 = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_5__["useMutation"])(INSERT_DISH, {
    onCompleted: function onCompleted(dishData) {
      ...
      Object(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["toastMessage"])(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["success"], 'Dish added');
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    ...
    if (_utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](chefData) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["hasProperty"](chefData, 'chefSpecializationProfilesByChefId') && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](chefData.chefSpecializationProfilesByChefId) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isArrayEmpty"](chefData.chefSpecializationProfilesByChefId.nodes) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](chefData.chefSpecializationProfilesByChefId.nodes[0])) {
      var data = chefData.chefSpecializationProfilesByChefId.nodes[0];
      setChefSavedDishes(_utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isArrayEmpty"](data.chefDishTypeId) ? data.chefDishTypeId : []); // setSelectedDishesId(util.isArrayEmpty(data.chefDishTypeId) ? data.chefDishTypeId : []);
    }
  ...
  var _useMutation5 = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_5__["useMutation"])(EDIT_BOOKING, {
    onCompleted: function onCompleted(data) {
      ...
      Object(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["toastMessage"])(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["success"], 'Booking edited Successfully');
    },
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (_utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](commissionData) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](commissionData.data) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isStringEmpty"](commissionData.data.getSettingValue)) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    ...
    if (_utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](chefData) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["hasProperty"](chefData, 'data') && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](chefData.data) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["hasProperty"](chefData.data, 'chefProfileByChefId') && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](chefData.data.chefProfileByChefId)) {
      ...
      if (_utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["hasProperty"](detail, 'chefProfileExtendedsByChefId') && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["hasProperty"](detail.chefProfileExtendedsByChefId, 'nodes')) {
        setProfileDetails(detail.chefProfileExtendedsByChefId.nodes[0]);

        if (_utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["hasProperty"](detail.chefProfileExtendedsByChefId.nodes[0], 'additionalServiceDetails') && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isStringEmpty"](detail.chefProfileExtendedsByChefId.nodes[0].additionalServiceDetails)) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (props.ProfileDetails && props.ProfileDetails.chefProfileExtendedsByChefId.nodes) {
      ...
      if (_utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["hasProperty"](details, 'additionalServiceDetails') && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isStringEmpty"](details.additionalServiceDetails)) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (_utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](listData) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["hasProperty"](listData, 'data') && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](listData.data) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["hasProperty"](listData.data, 'allStoreTypeMasters') && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isObjectEmpty"](listData.data.allStoreTypeMasters) && _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isArrayEmpty"](listData.data.allStoreTypeMasters.nodes)) {
  ...
  function nextClick() {
    if (complexityValue) {
      if (storeValue && storeValue.length > 0) {
        ...
        Object(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["toastMessage"])(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["renderError"], 'Please select a store to complete booking');
      }
    } else {
      Object(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["toastMessage"])(_utils_Toast__WEBPACK_IMPORTED_MODULE_13__["renderError"], 'Please select complexity to complete booking');
    }
  }
  ...
  function calculatePrice() {
    ...
    if (ProfileDetails) {
      ...
      var price = Object(_utils_priceCalculator__WEBPACK_IMPORTED_MODULE_12__["priceCalculator"])(baseRate, guest, complexity, _additionalServices, previousAdditinalServicePrice);
      setValuePrice(price);
    }
  }
  ...
  try {
    return __jsx("div", null, showAgreement === false && __jsx("div", {
    ...
    }, __jsx("div", null, ProfileDetails.noOfGuestsMin ? ProfileDetails.noOfGuestsMin : 1), __jsx("div", null, range), __jsx("div", null, ProfileDetails.noOfGuestsMax ? ProfileDetails.noOfGuestsMax : 150))))), _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_11__["isStringEmpty"](ProfileDetails.chefComplexity) && __jsx("div", {
      "class": "card"
    }, __jsx("div", {
      "class": "card-header",
      ...
      "class": "card-header",
      id: "booking-chef-details"
    }, __jsx("label", null, "Select Additional Services Provided by Chef")), __jsx("div", {
      className: "form-group",
      id: "bookingDetail"
    ...
    }, "Add Service")))), __jsx("br", null)), __jsx("br", null), calculatePriceYn && __jsx(_CalculatePrice__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
//# sourceMappingURL=profile-setup.js.aa82582046b9b78adb03.hot-update.js.map