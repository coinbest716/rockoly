...
var PriceCalculator = function PriceCalculator(props) {
  ...
  try {
    return __jsx("div", null, showAgreement === false && __jsx("div", {
    ...
    }, __jsx("div", null, ProfileDetails.noOfGuestsMin ? ProfileDetails.noOfGuestsMin : 1), __jsx("div", null, range), __jsx("div", null, ProfileDetails.noOfGuestsMax ? ProfileDetails.noOfGuestsMax : 150))))), console.log("ProfileDetails.chefComplexity", ProfileDetails.chefComplexity), _utils_checkEmptycondition__WEBPACK_IMPORTED_MODULE_10__["isStringEmpty"](ProfileDetails.chefComplexity) && __jsx("div", {
      className: "form-group",
      id: "bookingDetail"
    }, __jsx("label", {
      className: "label"
    }, "Select Complexity"), __jsx("div", null, __jsx("div", {
      className: "col-lg-12",
      ...
      if (data.complexcityLevel === '1X') {
        ...
        }))), __jsx("span", null, "1X"))))), __jsx("div", null));
      }
      ...
      if (data.complexcityLevel === '1.5X') {
        return __jsx("div", {
          ...
          points: "1.5 6 4.5 9 10.5 1"
        }))), __jsx("span", null, "1.5X"))))), __jsx("div", null));
      }
      ...
      if (data.complexcityLevel === '2X') {
        return __jsx("div", {
          ...
          points: "1.5 6 4.5 9 10.5 1"
        }))), __jsx("span", null, "2X"))))), __jsx("div", null));
      }
      ...
      className: "label"
    }, "Select Additional Services Provided by Chef"), availableService.map(function (data, index) {
...
//# sourceMappingURL=profile-setup.js.4458f9227301b99f925c.hot-update.js.map