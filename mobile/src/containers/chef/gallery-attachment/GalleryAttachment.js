...
export default class GalleryAttachment extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
      visible: false,
  ...
  setAttachments = ({attachments}) => {
    ...
    if (attachments && attachments.length) {
      ...
      } else if (selectedSectionType === SECTION_TYPE.LICENSE) {
  ...
  render() {
    ...
    return (
      <View style={Styles.container}>
        <Header showBack title={Languages.galleryAttachment.title} showBell={false} />
        <ScrollView>
          {isFetching ? (
            <Spinner mode="full" />
          ) : (
              ...
              <View style={Styles.iconBody}>
                ...
                <View style={Styles.iconText}>
                  <Text style={Styles.text}>
                    {Languages.chef_profile.chef_profile_lable.upload}
                  </Text>
...
GalleryAttachment.contextType = AuthContext
