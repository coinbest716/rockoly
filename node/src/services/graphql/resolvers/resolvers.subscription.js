...
const subscriptionResolvers = {
  ...
  conversationHistory: {
    subscribe: withFilter((_, args, {pubsub}) => pubsub.asyncIterator('conversationHistory'), (payload, variables) => {
      return doSubscribe(payload, variables, subs.subsConversationHistory);
    }),
  },
};
